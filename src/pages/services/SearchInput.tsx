...
function SearchInput() {
  return (
    <div className="absolute flex justify-between 
      md:w-[70%] w-[90%] p-2 rounded-lg ring-1
       ring-white bg-black -bottom-[25px] md:-bottom-[50px]"
    >
      <div className="flexcenter gap-2">
        ...
        <input 
          ...
          className="focus:outline-none w-full shrink min-w-0"
        />
      </div>

      <div className="flexcenter gap-2 hidden md:flex">
        <MapPinIcon className='text-green-500'/>
        <p className="text-sm">Pretoria, Sunnyside</p>
      </div>
